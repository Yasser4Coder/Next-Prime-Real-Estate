...
export default function PropertiesManage() {
  ...
  const [form, setForm] = useState({
    title: '', description: '', image: '', bedrooms: '', bathrooms: '', type: 'Villa', price: '', location: '', purpose: 'buy',
  ...
  const buildPayload = () => {
    ...
    if (form.overviewYearBuilt !== '') overview.yearBuilt = Number(form.overviewYearBuilt)
    if (form.overviewGarages !== '') overview.garages = Number(form.overviewGarages)
  ...
  const handleEdit = (p) => {
    ...
    setForm({
      ...
      addressLat: addr.lat ?? '',
      addressLng: addr.lng ?? '',
      overviewAreaSqft: ov.areaSqft ?? '',
      overviewStatus: ov.status ?? '',
      overviewYearBuilt: ov.yearBuilt ?? '',
      overviewGarages: ov.garages ?? '',
    ...
    <div>
      ...
      {showFormView ? (
        <div className="bg-white rounded-2xl border border-[#e1e1e1] overflow-hidden">
          ...
          <input type="number" placeholder="Price (AED)" value={form.price} onChange={(e) => setForm((f) => ({ ...f, price: e.target.value }))} className="px-3 py-2 rounded-xl border border-[#e1e1e1]" />
          ...
          <input type="number" placeholder="Bedrooms" value={form.bedrooms} onChange={(e) => setForm((f) => ({ ...f, bedrooms: e.target.value }))} className="px-3 py-2 rounded-xl border border-[#e1e1e1]" min="0" />
          <input type="number" placeholder="Bathrooms" value={form.bathrooms} onChange={(e) => setForm((f) => ({ ...f, bathrooms: e.target.value }))} className="px-3 py-2 rounded-xl border border-[#e1e1e1]" min="0" step="0.5" />
          ...
          <div className="sm:col-span-2 lg:col-span-3 border-t border-[#e1e1e1] pt-4 mt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <input type="number" placeholder="Area (sqft)" value={form.overviewAreaSqft} onChange={(e) => setForm((f) => ({ ...f, overviewAreaSqft: e.target.value }))} className="px-3 py-2 rounded-xl border border-[#e1e1e1]" min="0" />
              ...
              <input type="number" placeholder="Year built" value={form.overviewYearBuilt} onChange={(e) => setForm((f) => ({ ...f, overviewYearBuilt: e.target.value }))} className="px-3 py-2 rounded-xl border border-[#e1e1e1]" min="0" />
              <input type="number" placeholder="Garages" value={form.overviewGarages} onChange={(e) => setForm((f) => ({ ...f, overviewGarages: e.target.value }))} className="px-3 py-2 rounded-xl border border-[#e1e1e1]" min="0" />
            </div>
          </div>
          <div className="sm:col-span-2 lg:col-span-3">
              ...
              {list.map((p) => {
                ...
                return (
                  <tr key={p.id} className="border-b border-[#e1e1e1] hover:bg-[#fafafa]">
                    ...
                    <td className="p-3">{p.price?.toLocaleString?.() ?? p.price} AED</td>
